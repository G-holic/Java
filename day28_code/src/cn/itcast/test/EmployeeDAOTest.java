...
import cn.itcast.dao.EmployeeDAOImpl;
...
public class EmployeeDAOTest {
    ...
    public void test01() {
        ...
        at cn.itcast.dao.BaseDAOImpl.getList(BaseDAOImpl.java:62)
        at cn.itcast.dao.EmployeeDAOImpl.getAll(EmployeeDAOImpl.java:58)
	... 23 more
	...
	*/
        ...
        Can not set double field cn.itcast.bean.Employee.commissionPct to java.math.BigDecimal
        Caused by: java.lang.IllegalArgumentException: Can not set double field cn.itcast.bean.Employee.commissionPct to java.math.BigDecimal
        ...
        at cn.itcast.dao.BaseDAOImpl.getList(BaseDAOImpl.java:68)
        at cn.itcast.dao.EmployeeDAOImpl.getAll(EmployeeDAOImpl.java:61)
        ... 23 more
        ...
        /*
        问题3：
        java.lang.RuntimeException: java.lang.IllegalArgumentException: Can not set char field cn.itcast.bean.Employee.gender to java.lang.String
       mysql中char类型对应JavaString

         */
        /*
        问题4：
        java.lang.RuntimeException: java.lang.IllegalArgumentException: Can not set int field cn.itcast.bean.Employee.jobId to null value
...
//        char gender = input.next().charAt(0);//男
        ...
        employee.setBirthday(sf.parse(birthday));// 字符串转化为日期类型
