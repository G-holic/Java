package cn.itcast.keyword_关键字.method;
...
class Son extends Father{
    ...
    public void test(){
        System.out.println(getNum());//子类没有重写，直接用父类的getNum() 10
        System.out.println(this.getNum());//this.，写不写都一样，子类没有重写，直接用父类的getNum() 10
        System.out.println(super.getNum());//很明确，就是找父类的 10
    }
}
