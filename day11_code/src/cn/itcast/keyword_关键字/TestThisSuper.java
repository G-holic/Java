...
public class TestThisSuper {
    public static void main(String[] args) {
        ...
        System.out.println("f = " + f);//f = cn.itcast.keyword_关键字.Father@1b6d3586

        System.out.println("---------------");
        Son s = new Son();
        System.out.println("s = " + s);//s = cn.itcast.keyword_关键字.Son@4554617c

        System.out.println("---------------");
        f.method();//Father.method, this = cn.itcast.keyword_关键字.Father@1b6d3586

        System.out.println("---------------");
        s.method();//Father.method, this = cn.itcast.keyword_关键字.Son@4554617c

        System.out.println("---------------");
        Father ff = new Son();//cn.itcast.keyword_关键字.Son@74a14482,对应的是Son对象
        ff.method();//Father.method, this = cn.itcast.keyword_关键字.Son@74a14482
...
class Father {
    public Father() {
        ...
        cn.itcast.keyword_关键字.Father@1b6d3586

        new Son()时，这个this就是代表你正在new的Son类的对象
        cn.itcast.keyword_关键字.Son@4554617c
...
class  Son extends Father {
    public Son() {
//        super();隐含
        System.out.println(this);//cn.itcast.keyword_关键字.Son@4554617c
    }
}