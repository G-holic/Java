 ...
 */
public class StringMethod4_字节编码 {
    @Test
    public void test01(){
        String str = "hello";
    ...
    public void test04() throws IOException {
        ...
        System.out.println(Arrays.toString(bytes));//[63, 63, 63]  无法正确表示中文（丢失数据了）
    }
    ...
    public void test05() throws UnsupportedEncodingException {
        ...
        System.out.println("s1 = " + s1);// s1 = �й��

        String s2 = new String(data,"GBK");
        System.out.println("s2 = " + s2);// s2 = 尚硅谷
    }
}
