...
public class TestClassInfo {
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("name = " + name);// name = java.lang.String
       ...
       最后的二进制，某一个位有1的，就说明这个位对应的修饰符是存在的。
        ...
        for (Class anInterface : interfaces) {
            System.out.println(anInterface);// interface java.io.Serializable.. java.lang.Comparable..java.lang.CharSequence
        }
