...
A：当系统需要加载某个类时，通常是应用程序类加载器先接到任务，例如：要加载java.lang.String类型，
...
public class TestClassLoader {
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("String类的classLoader = " + classLoader);// String类的classLoader = null
        // 引导类加载器不是Java语言实现的，所以在Java中得不到它的对象。(c底层实现的）

        // 查看TestClassLoader类的类加载器是谁
        Class c2 = Class.forName("cn.itcast.reflect_反射.TestClassLoader");
        ...
        //loader3 = sun.misc.Launcher$ExtClassLoader@61bbe9ba

        Class c4 = Class.forName("cn.itcast.ext.demo.AtTest");
        ClassLoader loader4 = c4.getClassLoader();
        System.out.println("loader4 = " + loader4);
        // loader4 = sun.misc.Launcher$ExtClassLoader@511d50c0
