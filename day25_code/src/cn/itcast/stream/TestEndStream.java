...
public class TestEndStream {
    @Test
    public void test01() {
        boolean result = Stream.of(1, 2, 3, 5, 7)
                .allMatch(t -> t % 2 != 0);// 终结处理
    ...
    public void test02() {
        Optional<Integer> first = Stream.of(1, 2, 3, 4, 5)
                .findFirst();
        System.out.println("first = " + first);// first = Optional[1]
    }
    ...
    public void test03() {
        Optional<Integer> any = Stream.of(1, 2, 3, 4, 5)
                .findAny();
        System.out.println("any = " + any);// any = Optional[1]
    }
...
//                .max((t1,t2)->Integer.compare(t1,t2));
    ...
    public void test06() {
        Optional<Integer> result = Stream.of(1, 2, 3, 4, 5)
                 ...
                 */
                .reduce((t1, t2) -> t1 + t2);
        System.out.println("result = " + result);// result = Optional[15]
    }
    ...
    public void test07() {
        ...
        System.out.println("result = " + result);// result = Optional[5]
    }
    ...
    public void test09() {
        ...
        System.out.println("list = " + list);// list = [hello, hello, world, world, ok, atguigu]
        System.out.println("set = " + set);// set = [world, hello, ok]
    }
}
