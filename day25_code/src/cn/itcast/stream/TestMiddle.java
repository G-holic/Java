...
public class TestMiddle {
    ...
    public void test02() {
        // 去重 (去掉重复元素)
        Stream.of(1, 2, 3, 4, 5, 2, 4, 6, 3, 1) //创建Stream
                .distinct() // 中间加工处理
                .forEach(System.out::print);// 终结操作
        // 123456
    }
    ...
    public void test03() {
        ...
        Stream.of(1, 2, 3, 4, 5, 2, 4, 6, 3, 1) //创建Stream
                .distinct() // 中间加工处理
                .filter(t -> t % 2 == 0) // 中间加工处理
                .forEach(System.out::print);// 终结操作 246
    }
    ...
    public void test07() {
        ...
        long count = Stream.of(1, 2, 3, 4, 5, 2, 4, 6, 3, 1) //创建Stream
                .filter(t -> t % 2 == 0)
                .distinct() // 中间加工处理
                .peek(System.out::println)// 中间加工处理，打印剩下的偶数
                .count();// 终结操作
        System.out.println("偶数的个数一共有=" + count);
    }

    @Test
    public void test08() {
        Stream.of(4, 5, 2, 8, 1)// 创建Stream
                .sorted()
    ...
    public void test09() {
        ...
        list.stream()// 创建Stream
                .sorted(Comparator.comparing(Student::getName)) // 组件加工，排序
                .forEach(System.out::println);
    }
