...
public class TestCache {
    public static void main(String[] args) {
        ...
        Integer obj1 = 1;// 自动装箱，把int值转为包装类对象
        Integer obj2 = 1;
        System.out.println(obj1 == obj2); // true 比较两个对象的地址值
        System.out.println(obj1.equals(obj2));// true Integer 重写了Object的equals方法，比较两个包装对象里面的整数值
        ...
        Integer obj3 = 130;
        Integer obj4 = 130;
        System.out.println(obj3 == obj4); //false 比较两个对象的地址值 （缓存对象超过+127）
        ...
        System.out.println("---------------");
        Integer obj7 = Integer.valueOf(2);
        Integer obj8 = Integer.valueOf(2);
