...
public class MethodToString {
    public static void main(String[] args) {
        ...
        // cn.itcast.api.Student@1b6d3586
        System.out.println(s1);//用System.out.println方法打印对象时自动调用
        // cn.itcast.api.Student@1b6d3586

        String str = "hello";
        str = str + s1;// 拼接
        System.out.println(str); // hellocn.itcast.api.Student@1b6d3586

        System.out.println("-----------------");
        System.out.println(s1.hashCode()); // 获取s1读写的hashCode值，这里获取的是十进制值
        // 460141958 十进制， 它的十六进制值是 1B6D 3586
    }
}
