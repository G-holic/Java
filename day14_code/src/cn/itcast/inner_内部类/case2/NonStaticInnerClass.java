package cn.itcast.inner_内部类.case2;
/*
回忆：类的成员：
（1）成员变量
（2）成员方法
...
//        Outer.Inner in = out.new Inner();//创建非静态内部类的对象
        ...
        Outer.Inner in = out.getInner(); // getInner 创建了一个Inner对象了
        in.inFun(3);
    }
}
...
class Outer{
    ...
    class Inner  {//非静态内部类
        ...
        public void inFun(int b){
            ...
            System.out.println("b = " + b); // 局部变量 inFun(int b)
            System.out.println("Inner.b = " + this.b);//2 成员变量private int b = 2;
