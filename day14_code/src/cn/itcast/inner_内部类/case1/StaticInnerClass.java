package cn.itcast.inner_内部类.case1;
...
//        Outer.Inner.inFun();// 错误，不能使用类名直接调用
        //这里需要创建Inner类对象
        //这里不需要Outer的对象，因为Inner对于Outer来说是静态的
...
class Outer {
    ...
    static class Inner extends Father implements FatherInter {
...
//            System.out.println("outB = " + outB);//不可以 非静态无法在静态类中使用
        ...
        public void inFun() {
            System.out.println("静态内部类的非静态方法inFun");
        }
    ...
    public static void outMethod() {
        ...
        System.out.println("静态内部类的私有的非静态变量: " + in.b);// 通过对象
    }
}
