...
反序列化失败问题：
    ...
    java.io.InvalidClassException（无效的类异常）: cn.itcast.object.Student;
    local（本地） class incompatible（不相容的；矛盾的；）:
    stream（流） classdesc（类描述） serialVersionUID（序列化版本ID） = 4879064896271260245,
    local（本地） class serialVersionUID（序列化版本ID） = -6997138101523021136
...
public class TestObjectIO {
    ...
    public void test01() throws IOException {
        ...
        oos.writeObject(stu); // Student实现了Serializable接口（成功了）
        // java.io.NotSerializableException: cn.itcast.object.Student
    ...
    public void test02() throws IOException, ClassNotFoundException {
        ...
        System.out.println(Student.getTotal());// 4
    ...
    public void test04() throws IOException, ClassNotFoundException {
        ...
        list.add(new Student("小王",27,90));
//        System.out.println(list);//[Student{id=1, name='李四', age=24, score=0, tel='null'}, Student{id=2, name='王五', age=24, score=0, tel='null'},
        // Student{id=3, name='赵六', age=24, score=0, tel='null'}, Student{id=1, name='小王', age=27, score=0, tel='null'}]
