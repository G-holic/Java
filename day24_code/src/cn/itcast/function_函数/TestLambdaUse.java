...
public class TestLambdaUse {
    ...
    public void test01() { // 消费型
        ...
        // forEach方法的功能是遍历集合，并对集合的每一个元素做xx事情，具体做什么事情，
        ...
        //            }
        //        });*/
        list.forEach(s -> System.out.print(s + " "));// hello world lisi java bigdata
    }

    @Test
    public void test02() { // 供给型
        /*
           供给型接口Supplier<T>  抽象方法： T get()  无参有返回值
        例如：使用Lambda表达式给一个Supplier类型的变量赋值一个“李四"
         */
        // Supplier<String> s = () -> {return "李四";};
        /*
        Supplier<String> s = () -> "李四";
        method(s);// 李四
        */
        method(() -> "李四");// 李四
    }
    ...
    public void test03() {
        ...
        在Java8中，新增了一个Stream接口类型，它有一个静态方法
            ...
            供给型接口Supplier<T>  抽象方法： T get()  无参有返回值
         */
//        Stream.generate(()->{return Math.random();});//随机产生[0,1)范围的小数
//        Stream.generate(()->Math.random());//随机产生[0,1)范围的小数
        ...
        */
        ...
        Stream.generate(()->Math.random()).forEach((Double d)-> System.out.println(d));

    }

    @Test
    public void test04() {// 功能型
        /*
    ...
    public void test05() {
        ...
        // 把所有的value转为大写
        map.replaceAll((Integer key,String value)->value.toUpperCase());
        System.out.println(map);// {1=HELLO, 2=JAVA}
    }
}
